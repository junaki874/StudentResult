...
if (isset($_POST['submit'])) {
	...
	$query = "UPDATE student set class_id='$class_id',name='$name',fathername='$fathername',email='$email',password='$password',year='$year' where id='$pid'";
...
<input type="text" name="year" class="form-control" value="<?=$result['year']?>" required  placeholder="Enter Year Name" >
</div>
