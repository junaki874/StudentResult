...
<form action="loadstudent.php" method="post" accept-charset="utf-8">
  
<input type="hidden" class="form-control" name="id" placeholder="Enter Buyer Name">

<div class="form-group">
<label for="group name">Class</label>
<select name="class_id" id="class_id"  class="form-control" required="" onchange="getSubject(this.value,'displayclass')">
...
<!-- </div> -->
        ...
        <script type="text/javascript">
                function getSubject(class_id, divid){

                  console.log(class_id);
                $.ajax({
                    url: 'loadclass.php?class_id='+class_id, //call storemdata.php to store form data
