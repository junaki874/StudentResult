...
if(!empty($_POST['email']) && !empty($_POST['password'])) {
  ...
  $query=mysqli_query($con,"SELECT * FROM student WHERE email='".$a."' AND password='".$b."'");
  ...
  {
  session_start();
  $_SESSION['user_student']=$email;
  $_SESSION['user_studentid']=$dbid;
              ...
              <h4 class="font-weight-light"></h4>
                ...
                <form action="" method="post">
                  ...
                  <div class="mt-3 text-center">
                    <a href="index.php" class="auth-link text-white">Admin Login</a>
